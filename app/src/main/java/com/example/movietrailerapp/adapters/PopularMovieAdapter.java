...
public class PopularMovieAdapter extends RecyclerView.Adapter<PopularMovieAdapter.PopularMovieViewHolder> {
    ...
    public PopularMovieAdapter(ArrayList<MovieEntity> movieEntities, Context context) {
    ...
    @NonNull
    @Override
    public PopularMovieAdapter.PopularMovieViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new PopularMovieAdapter.PopularMovieViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull PopularMovieAdapter.PopularMovieViewHolder holder, int position) {
