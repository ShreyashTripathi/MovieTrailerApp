...
public class TopRatedMovieAdapter extends RecyclerView.Adapter<TopRatedMovieAdapter.TopRatedMovieViewHolder> {
    ...
    public TopRatedMovieAdapter(ArrayList<MovieEntity> movieEntities, Context context) {
    ...
    @NonNull
    @Override
    public TopRatedMovieAdapter.TopRatedMovieViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new TopRatedMovieAdapter.TopRatedMovieViewHolder(view);
    }
