...
public class UpcomingMoviesRepository {
    Context context;
    RequestQueue requestQueue;
    MoviesServerCallback serverCallback;

    public void getUpcomingMovieEntities(String type_, MoviesServerCallback serverCallback_) {
        parseMovieJSON(type_);
        this.serverCallback = serverCallback_;
    }

    public UpcomingMoviesRepository(Context context) {
